...
- [ ] FlatBuffers schema (`lip.fbs`)
- [ ] Rust bindings (generated + handwritten utilities)
- [ ] Dart bindings (for CKB/Cartographer integration)
- [ ] Daemon: Tree-sitter Tier 1 indexer
- [ ] Daemon: Salsa query graph (in-memory, single session)
- [ ] LIP-to-LSP bridge (definition, references, hover, workspace symbols)
- [ ] CLI: `lip index`, `lip query`, `lip import --from-scip`

### v0.2 — Persistence & incremental

- [ ] Persisted query graph (survives daemon restarts)
...
- [ ] Neovim plugin
- [ ] Language support: TypeScript, Rust, Dart, Go, Python, Java
