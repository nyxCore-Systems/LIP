...
mod tests {
    ...
    #[test]
    fn range_round_trip() {
        let lip = OwnedRange { start_line: 5, start_char: 10, end_line: 5, end_char: 20 };
    ...
    fn negative_range_clamped_to_zero() {
        let lip = OwnedRange { start_line: -1, start_char: -3, end_line: 0, end_char: 5 };
        let lsp = lip_range_to_lsp(&lip);
    ...
    fn hover_includes_signature_fenced() {
        ...
        assert!(mc.value.contains("```"), "signature should be in a code fence");
    ...
    fn location_from_valid_file_uri() {
        let range = OwnedRange { start_line: 1, start_char: 0, end_line: 1, end_char: 10 };
    ...
    fn location_from_invalid_uri_returns_none() {
        let range = OwnedRange { start_line: 0, start_char: 0, end_line: 0, end_char: 0 };
    ...
    fn occurrences_to_locations_filters_invalid() {
        let valid = OwnedOccurrence {
            ...
            range: OwnedRange { start_line: 0, start_char: 0, end_line: 0, end_char: 1 },
            confidence_score: 20,
